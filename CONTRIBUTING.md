...
1. [Fork](https://github.com/qualcomm/geniex-qairt-plugin/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/geniex-qairt-plugin.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/geniex-qairt-plugin/pulls) from your branch to `main`.
...
- Follow the C++ style defined in [`.clang-format`](.clang-format) (Google style, 4-space indent, 120-column limit). Run `clang-format -i` on any files you change before committing.
- Write tests.
