...
int main(int argc, char** argv) {
    ...
    const auto model_dir = std::filesystem::current_path() / "modelfiles" / "llama_v3_elyza_jp_8b_aihub";
    ...
    geniex::LLMModel model = geniex::llama_v3_elyza_jp_8b_aihub::makeModel();
    try {
