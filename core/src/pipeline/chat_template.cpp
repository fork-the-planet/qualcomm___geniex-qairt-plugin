...
std::string chatMLTemplate(const std::string& user_message, const std::string& system_prompt, bool enable_thinking) {
    std::string result;
...
std::string phiChatTemplate(
    ...
    std::string result;
    std::string sys = system_prompt.empty() ? "You are a helpful assistant." : system_prompt;
